    ...
    opts = {
        ...
        ui = {
            ...
            hl_groups = {
                ...
                ObsidianTodo = { bold = true, fg = require('gruvbox').palette.faded_blue },
                ObsidianDone = { bold = true, fg = require('gruvbox').palette.bright_blue },
                ObsidianRightArrow = { bold = true, fg = require('gruvbox').palette.bright_green },
                ...
                ObsidianBullet = { bold = true, fg = require('gruvbox').palette.bright_blue },
                ObsidianRefText = { underline = true, fg = require('gruvbox').palette.bright_yellow },
                ObsidianExtLinkIcon = { fg = require('gruvbox').palette.faded_blue },
                ObsidianTag = { italic = true, fg = require('gruvbox').palette.neutral_blue, bg = require('gruvbox').palette.dark1 },
                ObsidianBlockID = { italic = true, fg = require('gruvbox').palette.bright_blue },
                ObsidianHighlightText = { bg = require('gruvbox').neutral_blue},
            },
        },
        -- other fields ...
        templates = {
